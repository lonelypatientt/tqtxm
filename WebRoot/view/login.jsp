	...
	<head>
		...
		<style type="text/css">
			...
			.btn-primary {
				...
				filter: progid :         dximagetransform.microsoft.gradient (      
					  startColorstr =    
					    #6eb6de, endColorstr =         #4a77d4, GradientType =         0 )
					;
			...
			* {
			...
			body {
				...
				filter: progid :         DXImageTransform.Microsoft.gradient (       
					   startColorstr =    
					    '#3E1D6D', endColorstr =         '#092756', GradientType =        
					1 );
			}
		...
		<script src="view/js/prefixfree.min.js"></script>
	</head>
	<body>
		<p style="font-size:18px;color:red; text-align: center; margin-top: 135px" id="loginError" >${loginError}</p>
		<div class="login">
			<h1>
				Login
			</h1>
			<form method="post">
				<input id="un" type="text" name="u" placeholder="用户名" required="required" />
				<input id="up" type="password" name="p" placeholder="密码" required="required" />
				<a href="javascript:void(0)" onclick="login();" class="btn btn-primary btn-block btn-large">
					登录
				</a>
				<br/>
				<button type="reset" class="btn btn-primary btn-block btn-large">
					重置
				</button>
			</form>
		</div>
